...
import intentSolutionsGroupSlider from '../assets/intentSolutionsGroup.png';
import jdeesMarketGrillSlider from '../assets/jdeesMarketGrill.png';
    ...
    <div className='experience_sliderContainer'>
      ...
      <Slider {...settings}>
        ...
        <div className='experience_Block'>
          ...
          >
            <div className='experience_BlockBox_img full-width'>
              <img src={intentSolutionsGroupSlider} />
            </div>
        ...
        <div className='experience_Block'>
          ...
          >
            <div className='experience_BlockBox_img'>
              <img src={jdeesMarketGrillSlider} />
            </div>
